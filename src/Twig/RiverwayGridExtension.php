...
class RiverwayGridExtension extends \Twig_Extension
{
    ...
    {
        return array(
            new \Twig_SimpleFunction('riverway_grid', array($this, 'renderGrid'),
    ...
    public function renderGrid(\Twig_Environment $env)
    {
        ...
        return $env->render('@RiverwayGrid/grid.html.twig', array_merge($this->widget->getGridParams(), ['export_url'=>$exportUrl]));
    }
}
